...
function AddStory() {
  ...
  useEffect(() => {
    if (formdata.photo !== "") {
      try {
        const res = Axios.post("http://localhost:8080/addStory", formdata);
        setformdata({
          title: "",
          highlight: "",
          description: "",
  ...
  return (
    <div>
      <div className="add-story-container">
        <a
          href={void 0}
          onClick={() => navigate("/stories", { state: "STORY" })}
        >
          All Campusfeed
        </a>{" "}
        {">"} Create
        ...
        <form className="row" onSubmit={handleSubmit}>
          <div className="col-md-12">
            <div className="input-group">
              <input
                ...
                className="form-control add-photo-title shadow-none"
          ...
          <div className="col-md-12">
            <div className="add-story-photo">
              ...
              <a
                ...
                className="new-div"
              >
                <AddIcon style={{ fontSize: "20px" }} /> Key Highlights
              </a>
              <button className="btn btn-secondary btn-sm float-end" disabled>
                <PublicIcon style={{ fontSize: "20px", paddingRight: "2px" }} />
                Public Content
              </button>
            </div>
          </div>
          ...
          <div className="col-md-12">
            <div className="add-story-footer">
              ...
              >
                Publish Date{" "}
                <InfoIcon style={{ fontSize: "19px", color: "grey" }} />:
              </div>
              <div
